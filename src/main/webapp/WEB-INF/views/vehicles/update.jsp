                        ...
                        <form class="form-horizontal" method="post" action="/rentmanager/cars/update">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lconstructeur" name="constructeur" value="${constructeur}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nb_places" name="nb_places" value="${nbPlaces}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
